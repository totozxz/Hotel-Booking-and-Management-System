...
<body>
	<?php
		$result = mysqli_query($con,"SELECT * FROM rooms_book");
		?>
		<table class="container">
		<tr>
			<th><h1><div align="center">BookingID</div></h1></th>
			<th><h1><div align="center">RoomID</div></h1></th>
			<th><h1><div align="center">GuestName</div></h1></th>
			<th><h1><div align="center">SpecialRequest</div></h1></th>
		</tr>
		<?php while($row = mysqli_fetch_array($result)) :?>
			<tr>
				...
				<td><div align="center"><?php echo $row['SpecialRequest']; ?></div></td>
			</tr>	
		<?php endwhile ?>
		</table>
